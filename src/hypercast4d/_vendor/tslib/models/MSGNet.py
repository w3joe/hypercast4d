...
import torch.fft
from hypercast4d._vendor.tslib.layers.Embed import DataEmbedding
from hypercast4d._vendor.tslib.layers.MSGBlock import GraphBlock, simpleVIT, Attention_Block, Predict
...
def FFT_for_Period(x, k=2):
    ...
    frequency_list[0] = -torch.inf  # Never select the DC bin, including zero inputs.
